...
public class LoggerDemo {
	...
	public static void main(String[] args) {
		...
		while (i < 6) {
			...
			String num1 = driver.findElement(By.xpath("//div[text()=\"Today\"]/parent::div//span[@rel='births_today']"))
					.getText();
			System.out.println("Births today: " + num1);
			String num2 = driver.findElement(By.xpath("//div[text()=\"Today\"]/parent::div//span[@rel='dth1s_today']"))
					.getText();
			System.out.println("Deaths today: " + num2);
			String num3 = driver
					.findElement(By.xpath("//div[text()='This year']//parent::div//span[@rel='births_this_year']"))
					.getText();
			System.out.println("Births this year: " + num3);
			String num4 = driver
					.findElement(By.xpath("//div[text()='This year']//parent::div//span[@rel='dth1s_this_year']"))
					.getText();
